package com.analytique.vaadin.dashboard.view.dashboard;

import java.util.Collection;
import java.util.Iterator;

import com.analytique.vaadin.dashboard.component.SparklineChart;
import com.analytique.vaadin.dashboard.component.TopGrossingMoviesChart;
import com.analytique.vaadin.dashboard.component.TopTenMoviesTable;
import com.analytique.vaadin.dashboard.domain.DashboardNotification;
import com.analytique.vaadin.dashboard.event.DashboardEvent;
import com.google.common.eventbus.Subscribe;
import com.vaadin.data.Property;
import com.analytique.vaadin.dashboard.DashboardUI;
import com.analytique.vaadin.dashboard.component.TopSixTheatersChart;
import com.analytique.vaadin.dashboard.data.dummy.DummyDataGenerator;
import com.analytique.vaadin.dashboard.event.DashboardEventBus;
import com.analytique.vaadin.dashboard.view.dashboard.DashboardEdit.DashboardEditListener;
...
public final class DashboardView extends Panel implements View,
    ...
    private Component buildHeader() {
        ...
        Label theaterComboLable= new Label("Theater");
        HorizontalLayout tools = new HorizontalLayout(theaterComboLable,buildTheaterCombo(),notificationsButton, edit);
    ...
    private Component buildTheaterCombo(){
        final ComboBox theater = new ComboBox();
        theater.addItem("hemant");
        theater.addItem("hemant1");
        theater.addItem("hemant2");
        theater.addListener(new Property.ValueChangeListener() {
